...
% \end{figure}
    ...
    \par LEACH\textcolor{white}{e}\cite{palan2017low} is an adaptive\textcolor{white}{e}protocol which uses\textcolor{white}{e}clustering of\textcolor{white}{e}sensor node and distributes energy\textcolor{white}{e}load equally in\textcolor{white}{e}all nodes of\textcolor{white}{e}cluster. This routing algorithm works in two\textcolor{white}{e}phases as shown\textcolor{white}{e}in Figure\textcolor{white}{e}\ref{LeachPhases}. Phase\textcolor{white}{e}1 is Setup-phase where election of CH, joining of member node in clusters, and TDMA time slots allotted to each member node by CH. In phase 2 which is steady-state\textcolor{white}{e}phase, member nodes sends their\textcolor{white}{e}data to CH in their allotted time slot. LEACH also involves\textcolor{white}{e}data aggregation at\textcolor{white}{e}CH, aggregated data is then sent to BS.
    \begin{figure}[htb]
    \center	
